# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2016-12-28 07:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spotify_id', models.CharField(max_length=64, verbose_name='Spotify user ID')),
                ('spotify_access_token', models.CharField(max_length=256, verbose_name='Spotify Web API Access Token')),
                ('spotify_access_expiry', models.DateTimeField(verbose_name='Spotify Access Token Expiry Date')),
                ('spotify_refresh_token', models.CharField(max_length=256, verbose_name='Spotify Web API Refresh Token')),
            ],
        ),
        migrations.CreateModel(
            name='Room',
            fields=[
                ...
                ('host', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='crowd_control.HostDetail')),
            ],
        ),
        migrations.CreateModel(
            name='Track',
